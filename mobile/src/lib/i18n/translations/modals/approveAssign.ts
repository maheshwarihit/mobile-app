export const en = {
  "modal.approveAssign.title": "Approve & Assign",
  "modal.approveAssign.assignedTitle": "Assigned to {name}",
  "modal.approveAssign.messageNow": "Let them know right away — opens WhatsApp with the details pre-filled.",
  "modal.approveAssign.messageOnWhatsapp": "Message on WhatsApp",
...
export const ta: Record<keyof typeof en, string> = {
  "modal.approveAssign.title": "அங்கீகரித்து ஒதுக்கு",
  "modal.approveAssign.assignedTitle": "{name}-க்கு ஒதுக்கப்பட்டது",
  "modal.approveAssign.messageNow": "உடனே தெரிவிக்கவும் — விவரங்கள் முன் நிரப்பப்பட்ட WhatsApp-ஐ திறக்கும்.",
  "modal.approveAssign.messageOnWhatsapp": "WhatsApp-இல் செய்தி அனுப்பு",
