  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50 dark:bg-slate-900" edges={[]}>
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 40 }}>
        <PageHeader
          title="Payment QR"
          subtitle="Shown to clients on the Payment screen for online payments. Changed by a developer directly, not from this app."
        />

        <Card className="items-center gap-2 p-6">
          <Text className="text-sm font-medium text-gray-500 dark:text-gray-400">Current QR</Text>
          {loadFailed ? (
            <View className="h-56 w-56 items-center justify-center rounded-xl border border-dashed border-gray-300 bg-gray-50 dark:border-slate-600 dark:bg-slate-800">
              ...
              <Text className="mt-2 text-xs text-gray-400 dark:text-gray-500">No QR code uploaded yet</Text>
            </View>
          ) : (
